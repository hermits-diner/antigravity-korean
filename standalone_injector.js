(function () {
  'use strict';
  console.log('[Antigravity-i18n] Updating Bilingual Korean (English) localization rules...');
  ...
  function translateNode(node) {
    ...
    // General 특수 처리: 사이드바는 '일반설정 (General)', 본문 섹션은 '일반 (General)'
    if (
      trimmed === 'General' ||
      trimmed === 'general' ||
      trimmed === '일반설정' ||
      ...
      const targetText = isSidebarNav ? '일반설정 (General)' : '일반 (General)';
  ...
  function start() {
    ...
    console.log('[Antigravity-i18n] Bilingual localization active and watching!');
  }
